// await axios.get(`${file.uri.href}`,{
//     method:"POST",
//     headers: {
//       'Authorization'   : `${file.headers.Authorization}`,
//       'Content-Type'    : 'application/json',
//       'Carbone-Version' : '2'
//     },
//     body:JSON.stringify({
//           convertTo:req.body.to,
//         data:{
//             name:"Roshan gujiri"
//         }
//     }),
...
//   .then(result=>{
//   console.log(result)
//   fs.writeFileSync(`ab.${req.body.to}`,result.data)
//   })
...
exports.documentGenerator = async (req, res, next) => {
    try {
        var data = {
            ...req.body
        }
